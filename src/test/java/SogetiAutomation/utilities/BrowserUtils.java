package SogetiAutomation.utilities;
...
public class BrowserUtils{
    ...
    public static String parseColor(String cssColorCode) {
        return Color.fromString(cssColorCode).asHex();
    }




    protected String getColor(WebElement element) {
        return parseColor(element.getCssValue("color"));
    }
